"""
prebid: PbjsDisplayMantisSignalsBidTest
...
_JS = (Path(__file__).parent.parent / "js" / "pbjs_display_mantis_signals_bid.js").read_text()

class PbjsDisplayMantisSignalsBidTest(BaseTest):
